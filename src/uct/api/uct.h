    ...
    struct {
        struct {
            ...
            size_t           max_iov;    /**< Maximal @a size of @ref ::uct_iov_t
                                              @a iov parameter in @ref ::uct_ep_put_zcopy
        ...
        struct {
            ...
            size_t           max_zcopy;  /**< Maximal size for get_zcopy (total
                                              ...
                                              @a iov parameter) */
            size_t           max_iov;    /**< Maximal @a size of @ref ::uct_iov_t
                                              @a iov parameter in @ref ::uct_ep_get_zcopy
        ...
        struct {
            ...
            size_t           max_iov;    /**< Maximal @a size of @ref ::uct_iov_t
                                              @a iov parameter in @ref ::uct_ep_am_zcopy
 ...
 *                         @a iovlen is limited by @ref uct_iface_attr_cap_put_max_iov
 ...
 * @param [in] iovlen      Size of the @a iov data @ref ::uct_iov_t structures
 *                         array. If @a iovlen is zero, the data is considered empty.
 *                         @a iovlen is limited by @ref uct_iface_attr_cap_get_max_iov
 ...
 * @param [in] iovlen        Size of the @a iov data @ref ::uct_iov_t structures
 *                           array. If @a iovlen is zero, the data is considered empty.
 *                           @a iovlen is limited by @ref uct_iface_attr_cap_am_max_iov
